...
class TLClassifier(object):
    def __init__(self):
        ...
        labels_filename = '/home/student/system-integration/ros/src/tl_detector/light_classification/model/sim_labels.txt'  #tl_detector/light_classification/
        self.graph_filename = '/home/student/system-integration/ros/src/tl_detector/light_classification/model/sim_graph.pb'
    ...
    def run_graph(self, image_data, labels, input_layer_name, output_layer_name,
        ...
        with tf.Session() as sess:
            self.load_graph(self.graph_filename)
    ...
    def get_classification(self, image):
        ...
        #image_data = self.load_image('/home/student/system-integration/ros/src/tl_detector/light_classification/test_data/test_green1.png')
